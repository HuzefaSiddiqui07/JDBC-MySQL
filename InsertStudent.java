...
public class InsertStudent {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Create the statement & Prepare the SQL statement
			PreparedStatement pStmnt = con.prepareStatement("insert into student(username , password)values(? , ?)");
			
			pStmnt.setString(1, "admin1"); // 1 first parameter in query
			pStmnt.setString(2, "guest1");
